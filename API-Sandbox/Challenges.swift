...
internal func exerciseOne() {
     ...
     */
	print("\(firstName) \(lastName) lives at \(streetName) in \(cityName), \(stateName), \(zipCode) and is a resident of \(country). If you want to contact them, you can email \(title) \(firstName) at \(email) or call their cell at \(cell).")
